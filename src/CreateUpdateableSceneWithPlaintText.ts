import { CreateUpdateSceneFromText } from "./updateable_scene/CreateUpdateSceneFromText";
 ...
 export class CreateUpdateableSceneWithPlainTextEquations {
    ...
    create_labled_field(field_id:string, field_prompt: string, field_type: string){
