...
import { CreateUpdateableSceneWithPlainTextEquations } from "./updateable_scene/CreateUpdateableSceneWithPlaintText";
import { ISceneCreator } from "./ISceneCreator";


function setup_given_scene_creator(scene_factory: ISceneCreator){
...
setup_given_scene_creator(new CreateUpdateableSceneWithPlainTextEquations())
